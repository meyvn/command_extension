...
Everyone interacting in the CommandExtension project’s codebases, issue trackers, chat rooms and mailing lists is expected to follow the [code of conduct](https://github.com/[USERNAME]/command_extension/blob/master/CODE_OF_CONDUCT.md).
